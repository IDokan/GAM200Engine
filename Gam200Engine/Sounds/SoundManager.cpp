...
{
    theResult = FMOD_System_CreateSound(fmod_system, "SoundAssets/jamjam.mp3", FMOD_DEFAULT, nullptr, &sound[JAMJAMTEST_SOUND]);//fmod_system->createSound("SoundAssets/jamjam.mp3", FMOD_DEFAULT, nullptr, &sound[JAMJAMTEST_SOUND]);//Guess...we can know what kinds of sound it is by the last parameter
